...
Circuit Description: Design uses a controller from ST Micro with part number STM32F429ZIY6 and following parts in the design:
1). AT25010B-SSHL-T from Atmel
2). TST-110-05-T-D-RA from Samtec
3). MAX3051EKA+T from Maxim Integrated
4). 182-009-113R531 from Norcomp Inc
5). MCP2562-E/SN from Microchip
6). 182-009-113R531 from Norcomp Inc
7). mt28ew256aba1HPC-0SIT from Micron
