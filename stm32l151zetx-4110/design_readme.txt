...
Circuit Description: Design uses a controller from ST Micro with part number STM32L151ZET6 and following parts in the design:
1). AT25128B-SSHL-T from Atmel
2). TST-110-05-T-D-RA from Samtec
3). MBH7BLZ02-109004 from Fujitsu
4). PCF85063TP/1Z from NXP
5). Si7051-A20-IM from Silicon Labs
