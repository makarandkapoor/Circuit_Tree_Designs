...
Circuit Description: Design uses a controller from ST Micro with part number stm32f042g6u6 and following parts in the design:
1). MAX3218EAP+T from Maxim Integrated
2). 182-009-113R531 from Norcomp Inc
3). ST3241EBPR from ST Microelectronics
4). 182-009-113R531 from Norcomp Inc
5). TSC2046IRGVR from Texas Instruments
