...
Circuit Description: Design uses a controller from ST Micro with part number STM32F745IGT6 and following parts in the design:
1). arducam_ov2640 from arducam
2). 24AA01T-I/MNY from Microchip
3). mt28ew512aba1HPC-0AAT from Micron
4). USB3317C-CP-TR from Microchip Technology
...
10). ASFL1-26MHZ-NCS from abracon
