...
Circuit Description: Design uses a controller from ST Micro with part number STM32F328C8T6 and following parts in the design:
1). AT25128B-SSHL-T from Atmel
2). SN65HVD230D from Texas Instruments
...
10). LSF0102DCTR from Texas Instrument
