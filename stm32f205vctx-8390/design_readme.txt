...
Circuit Description: Design uses a controller from ST Micro with part number STM32F205VCT6 and following parts in the design:
1). AT25040B-SSHL-T from Atmel
2). TST-110-05-T-D-RA from Samtec
3). 24AA64T-I/MNY from Microchip
4). Si7034-A10-IM from Silicon Labs
5). ASEK-32.768KHz-ECST from abracon
6). ASFL1-25MHZ-NCS from abracon
7). LP2954AIMX/NOPB from TI
