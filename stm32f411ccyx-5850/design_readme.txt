...
Circuit Description: Design uses a controller from ST Micro with part number STM32F411CCY6 and following parts in the design:
1). AT25040B-SSHL-T from Atmel
2). AT24C02D-SSHM-T from Atmel
3). MBH7BLZ02-109004 from Fujitsu
