...
Circuit Description: Design uses a controller from ST Micro with part number stm32f051c8u7 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). XB24CZ7UIS-004 from Digi International
3). ASEK-32.768KHz-ECST from abracon
4). ASFL1-25MHZ-NCS from abracon
5). LP3878SDX-ADJ/NOPB  from TI
6). TPS3895ADRYR from Texas Instruments
7). PJ-037B from CUI Inc.
8). 4-1437565-2 from TE connectivity
9). Q65110A2395 from osram
10). nc7sz125m5x from On Semi
