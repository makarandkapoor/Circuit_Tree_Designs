...
Circuit Description: Design uses a controller from ST Micro with part number STM32F303CBT6 and following parts in the design:
1). AT25020B-SSHL-T from Atmel
2). BMC150 from Bosch Sensortec
3). TST-110-05-T-D-RA from Samtec
4). SPBTLE-RF from ST Microelectronics
