...
Circuit Description: Design uses a controller from ST Micro with part number STM32F745IEK7 and following parts in the design:
1). A2500R24A00GM from Anaren
2). TST-110-05-T-D-RA from Samtec
3). mt28ew512aba1HPC-0AAT from Micron
4). ABS07-32.768KHZ-7-T from ABRACON
5). ABLS-25.000MHZ-B2F-T from ABRACON
6). LP3878SDX-ADJ/NOPB  from TI
7). LTC3601EUD#PBF from Linear Tech
8). LTC2928CUHF#PBF from Linear Tech
9). IRF8306MTRPbF from Infineon
10). IRF8306MTRPbF from Infineon
11). PJ-037B from CUI Inc.
