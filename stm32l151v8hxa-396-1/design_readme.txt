...
Circuit Description: Design uses a controller from ST Micro with part number STM32L151V8H6A and following parts in the design:
1). SPBTLE-RF from ST Microelectronics
2). TSC2014IYZGT from Texas Instruments
