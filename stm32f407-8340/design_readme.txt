...
Circuit Description: Design uses a controller from ST Micro with part number STM32F407IGH6 and following parts in the design:
1). AT25256B-SSHL-T from Atmel
2). AT25640B-SSHL-T from Atmel
3). BCM5221KPT from Broadcom Corporation
4). 7498011122R from WURTH ELEKTRONIK
5). TST-110-05-T-D-RA from Samtec
6). 24AA16-I/MC from Microchip
