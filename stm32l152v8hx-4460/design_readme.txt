...
Circuit Description: Design uses a controller from ST Micro with part number STM32L152V8H6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). MAX3218EAP+T from Maxim Integrated
3). 182-009-113R531 from Norcomp Inc
4). 24AA128T-I/MNY from Microchip
