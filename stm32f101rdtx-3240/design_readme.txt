...
Circuit Description: Design uses a controller from ST Micro with part number STM32F101RDT6 and following parts in the design:
1). A2200-A from Maestro Wireless Solutions
2). 73412-0114 from Molex
3). AT25128B-SSHL-T from Atmel
