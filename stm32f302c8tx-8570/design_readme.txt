...
Circuit Description: Design uses a controller from ST Micro with part number STM32F302C8T7 and following parts in the design:
1). AT25128B-SSHL-T from Atmel
2). AT25512N-SH-T from Atmel
3). MAX3218EAP+T from Maxim Integrated
4). HTSS-105-01-G-D from samtec
5). 24AA1025T-I/SN from Microchip
