...
Circuit Description: Design uses a controller from ST Micro with part number STM32L151VDY6XTR and following parts in the design:
1). AT25320B-SSHL-T from Atmel
2). FTSH-105-01-L-DV-K from Samtec
3). 24AA256-I/MF from Microchip
4). WM8731CLSEFL from Cirrus Logic
