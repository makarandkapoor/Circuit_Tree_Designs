...
Circuit Description: Design uses a controller from ST Micro with part number STM32L151VCT6A and following parts in the design:
1). TST-110-05-T-D-RA from Samtec
2). M24M02-DRMN6TP from ST
3). MAX3218EAP+T from Maxim Integrated
4). HTSS-105-01-G-D from samtec
5). MPU-9250 from TDK InvenSense
