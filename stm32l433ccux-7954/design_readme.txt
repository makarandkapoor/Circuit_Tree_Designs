...
Circuit Description: Design uses a controller from ST Micro with part number STM32L433CCU6 and following parts in the design:
1). CC3200MODR1M2AMOBT from Texas Instruments
2). 73412-0114 from Molex
3). FTSH-105-01-L-DV-K from Samtec
4). MAX3218EAP+T from Maxim Integrated
5). HTSS-105-01-G-D from samtec
6). Si7034-A10-IM from Silicon Labs
7). SST26VF032B-104I/MF from Microchip
8). ASEK-32.768KHz-ECST from abracon
9). ASFL1-25MHZ-NCS from abracon
10). LP3878SDX-ADJ/NOPB  from TI
11). LP2951ACSDX/NOPB from TI
12). TPS3895ADRYR from Texas Instruments
13). PJ-037B from CUI Inc.
14). LSF0102DCTR from Texas Instrument
15). LSF0108PWR from Texas Intrument
