...
Circuit Description: Design uses a controller from ST Micro with part number STM32L152R8T6A and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). TMD27711 from AMS
3). ABLS-25.000MHZ-B2F-T from ABRACON
4). ASEK-32.768KHz-ECST from abracon
5). IR3899MTR1PBF from Infineon
