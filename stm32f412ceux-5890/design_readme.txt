...
Circuit Description: Design uses a controller from ST Micro with part number STM32F412CEU6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). MCP2562-E/SN from Microchip
3). 182-009-113R531 from Norcomp Inc
4). SN65HVD230D from Texas Instruments
5). 182-009-113R531 from Norcomp Inc
6). 61400416021 from Wurth Electronics
7). prtr5v0u2ax from NXP
8). XB24CZ7UIS-004 from Digi International
9). ABS07-32.768KHZ-7-T from ABRACON
10). ASFL1-25MHZ-NCS from abracon
11). LP2954AIMX/NOPB from TI
12). IR3899MTR1PBF from Infineon
13). TPS3895ADRYR from Texas Instruments
14). PJ-037B from CUI Inc.
