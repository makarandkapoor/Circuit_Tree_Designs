...
Circuit Description: Design uses a controller from ST Micro with part number STM32F401VET6 and following parts in the design:
1). AT25010B-SSHL-T from Atmel
2). AT25128B-SSHL-T from Atmel
3). AT25512N-SH-T from Atmel
