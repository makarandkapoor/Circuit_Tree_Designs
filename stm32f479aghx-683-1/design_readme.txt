...
Circuit Description: Design uses a controller from ST Micro with part number STM32F479AGH6 and following parts in the design:
1). arducam_ov2640 from arducam
2). FT232RL-REEL from FTDI Ltd
3). 10118193-0001LF from FCI
4). LTC2804CGN-1#PBF from Linear Tech
5). 182-009-113R531 from Norcomp Inc
6). ABS07-32.768KHZ-7-T from ABRACON
7). ABLS-12.000MHZ-B4-T from ABRACON
8). ASFL1-25MHZ-NCS from abracon
9). idt74fct38072 from IDT
