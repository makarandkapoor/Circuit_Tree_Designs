...
Circuit Description: Design uses a controller from ST Micro with part number STM32F101RCT6 and following parts in the design:
1). AT25010B-SSHL-T from Atmel
2). AT25040B-SSHL-T from Atmel
3). AT25M01-SSHM-T from Atmel
