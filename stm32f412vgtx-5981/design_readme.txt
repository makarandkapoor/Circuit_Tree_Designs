...
Circuit Description: Design uses a controller from ST Micro with part number STM32F412VGT6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). 0472192001 from Molex
3). RFM75-S from HopeRF
4). SST26WF040BT-104I/NP from Microchip
