...
Circuit Description: Design uses a controller from ST Micro with part number STM32F318C8T6 and following parts in the design:
1). 24AA32AT-I/MNY from Microchip
2). ABS07-32.768KHZ-7-T from ABRACON
3). ASDMB-25.000MHZ-EC-T from abracon
