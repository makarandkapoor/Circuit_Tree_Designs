...
Circuit Description: Design uses a controller from ST Micro with part number STM32L151RBH6A and following parts in the design:
1). FT232RL-REEL from FTDI Ltd
2). 10118193-0001LF from FCI
3). TMP75BID from Silicon Labs
