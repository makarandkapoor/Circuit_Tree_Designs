...
Circuit Description: Design uses a controller from ST Micro with part number stm32f071cbu7 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). WM8731CLSEFL from Cirrus Logic
3). SJ-43515TS-SMT-TR from CUI Inc.
4). SJ-43515TS-SMT-TR from CUI Inc.
5). ABS07-32.768KHZ-7-T from ABRACON
6). ABLS-12.288MHZ-B4-T from ABRACON
