...
Circuit Description: Design uses a controller from ST Micro with part number STM32F215VGT6 and following parts in the design:
1). BMC150 from Bosch Sensortec
2). ESP8266-12E from Ai Thinker
3). FTSH-105-01-L-DV-K from Samtec
4). 0472192001 from Molex
5). 47590-0001 from Molex
