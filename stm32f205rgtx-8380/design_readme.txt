...
Circuit Description: Design uses a controller from ST Micro with part number STM32F205RGT6 and following parts in the design:
1). 61400416021 from Wurth Electronics
2). prtr5v0u2ax from NXP
3). 61400416021 from Wurth Electronics
4). prtr5v0u2ax from NXP
5). ABS07-32.768KHZ-7-T from ABRACON
6). ASFL1-25MHZ-NCS from abracon
7). LP2954AIMX/NOPB from TI
8). TPS61085DGKR from Texas instrument
