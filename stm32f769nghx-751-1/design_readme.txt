...
Circuit Description: Design uses a controller from ST Micro with part number STM32F769NGH6 and following parts in the design:
1). AT25M02-SSHD-T from Atmel
2). FTSH-105-01-L-DV-K from Samtec
3). LH430WV2-SD01 from LG Displays
4). mtfc4gmcdm from Micron
5). TH58NVG3S0HBAI4 from Toshiba
6). ASEK-32.768KHz-ECST from abracon
7). ASFL1-25MHZ-NCS from abracon
8). MIC5234YME from microchip
9). LP3878SDX-ADJ/NOPB  from TI
10). LTC3601EUD#PBF from Linear Tech
