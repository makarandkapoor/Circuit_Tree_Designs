...
Circuit Description: Design uses a controller from ST Micro with part number STM32L431CBYx and following parts in the design:
1). 24AA01T-I/MNY from Microchip
2). 24AA04-I/MC from Microchip
3). MCP2562-E/SN from Microchip
4). 182-009-113R531 from Norcomp Inc
5). SP3203ECY-L/TR from EXAR Corp
6). HTSS-105-01-G-D from samtec
7). SP3203ECY-L/TR from EXAR Corp
8). HTSS-105-01-G-D from samtec
9). ABS07-32.768KHZ-7-T from ABRACON
10). ASFL1-25MHZ-NCS from abracon
11). MIC5234YME from microchip
