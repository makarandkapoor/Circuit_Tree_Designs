...
Circuit Description: Design uses a controller from ST Micro with part number STM32F429ZGT6 and following parts in the design:
1). AT25M02-SSHD-T from Atmel
2). KSZ8081RNBIA-TR from Microchip
3). 7498011122R from WURTH ELEKTRONIK
4). S29VS256RABBHW000 from Spansion
