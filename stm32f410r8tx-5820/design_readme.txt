...
Circuit Description: Design uses a controller from ST Micro with part number STM32F410R8T6 and following parts in the design:
1). ETRX3587 from Telegesis
...
7). ABLS-12.288MHZ-B4-T from ABRACON
