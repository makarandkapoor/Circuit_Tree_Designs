...
Circuit Description: Design uses a controller from ST Micro with part number STM32F205RFT6 and following parts in the design:
1). MAX3051EKA+T from Maxim Integrated
2). 182-009-113R531 from Norcomp Inc
3). 24AA32AT-I/MNY from Microchip
4). MPU-9250 from TDK InvenSense
