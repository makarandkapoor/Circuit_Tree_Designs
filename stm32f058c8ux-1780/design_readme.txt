...
Circuit Description: Design uses a controller from ST Micro with part number stm32f058c8u7 and following parts in the design:
1). ABLS-25.000MHZ-B2F-T from ABRACON
2). ASEK-2-32.768KHz-ECST from abracon
3). ltc3406es5 from Linear Tech
4). TPS3895ADRYR from Texas Instruments
5). MCP73831T-2ACI/MC from microchip
6). S2B-PH-SM4-TB(LF)(SN) from JST Sales America Inc.
