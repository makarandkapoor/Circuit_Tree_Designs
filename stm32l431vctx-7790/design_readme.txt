...
Circuit Description: Design uses a controller from ST Micro with part number STM32L431VCT6 and following parts in the design:
1). AT25020B-SSHL-T from Atmel
2). FTSH-105-01-L-DV-K from Samtec
3). SP3203ECY-L/TR from EXAR Corp
4). HTSS-105-01-G-D from samtec
5). SST26VF016B-104I/MF from Microchip
