...
Circuit Description: Design uses a controller from ST Micro with part number STM32F427ZGT6 and following parts in the design:
1). AT25512N-SH-T from Atmel
2). 88E3015A2NNP1C000 from Marvell
3). 7498011122R from WURTH ELEKTRONIK
4). PC28F512P33BFD from Micron
5). SGTL5000XNAA3 from Freescale
6). SJ-43515TS-SMT-TR from CUI Inc.
7). SJ-43515TS-SMT-TR from CUI Inc.
8). SJ-43515TS-SMT-TR from CUI Inc.
9). WM-64PCT from Panasonic
...
17). ASFL1-25MHZ-NCS from abracon
18). LP3878SDX-ADJ/NOPB  from TI
19). LTC3601EUD#PBF from Linear Tech
20). LP2951ACSDX/NOPB from TI
21). TPS3895ADRYR from Texas Instruments
