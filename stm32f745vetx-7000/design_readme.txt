...
Circuit Description: Design uses a controller from ST Micro with part number STM32F745VET6 and following parts in the design:
1). arducam_ov2640 from arducam
2). AT24C02D-SSHM-T from Atmel
3). MAX3051EKA+T from Maxim Integrated
4). 182-009-113R531 from Norcomp Inc
5). RTL8201FL-VB-CG from Realtek
6). 7498011122R from WURTH ELEKTRONIK
7). TSC2008TRGVRQ1 from Texas Instruments
8). HTSS-105-01-G-D from samtec
9). ABLS-25.000MHZ-B2F-T from ABRACON
10). ASEK-32.768KHz-ECST from abracon
11). ASFL1-25MHZ-NCS from abracon
12). idt74fct38072 from IDT
13). tps54325PWP from Texas Instruments
14). TPS3895ADRYR from Texas Instruments
