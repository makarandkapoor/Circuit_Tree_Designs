...
Circuit Description: Design uses a controller from ST Micro with part number STM32F427IGT6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). KSZ8081RNBIA-TR from Microchip
3). 7498011122R from WURTH ELEKTRONIK
4). 24AA02T-I/MNY from Microchip
5). 0472192001 from Molex
6). mt28ew256aba1HPC-0SIT from Micron
7). ABS07-32.768KHZ-7-T from ABRACON
8). ABLS-25.000MHZ-B2F-T from ABRACON
9). ABLS-25.000MHZ-B2F-T from ABRACON
10). ASFL1-50MHZ-NCS from abracon
