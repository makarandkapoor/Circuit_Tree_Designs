...
Circuit Description: Design uses a controller from ST Micro with part number stm32f098cct7 and following parts in the design:
1). AT25M01-SSHM-T from Atmel
2). MAX3051EKA+T from Maxim Integrated
3). 182-009-113R531 from Norcomp Inc
4). 24AA00T-I/MNY from Microchip
5). TSC2008TRGVRQ1 from Texas Instruments
6). HTSS-105-01-G-D from samtec
7). ASEK-2-32.768KHz-ECST from abracon
