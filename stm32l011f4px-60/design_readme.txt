...
Circuit Description: Design uses a controller from ST Micro with part number STM32L011F4P6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). AT24C02D-SSHM-T from Atmel
3). S25FL128SDPNFI001 from Spansion
