...
Circuit Description: Design uses a controller from ST Micro with part number STM32L475RET6 and following parts in the design:
1). MAX3051EKA+T from Maxim Integrated
2). 182-009-113R531 from Norcomp Inc
3). 24AA02T-I/MNY from Microchip
4). TSC2014IYZGT from Texas Instruments
