...
Circuit Description: Design uses a controller from ST Micro with part number STM32F429BIT6 and following parts in the design:
1). BCM5221KPT from Broadcom Corporation
2). 7498011122R from WURTH ELEKTRONIK
3). TST-110-05-T-D-RA from Samtec
4). 47590-0001 from Molex
5). prtr5v0u2ax from NXP
6). ABS07-32.768KHZ-7-T from ABRACON
7). ABLS-25.000MHZ-B2F-T from ABRACON
8). ASFL1-25MHZ-NCS from abracon
9). IR3899MTR1PBF from Infineon
10). IR3899MTR1PBF from Infineon
