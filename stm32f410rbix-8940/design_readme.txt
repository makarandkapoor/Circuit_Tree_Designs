...
Circuit Description: Design uses a controller from ST Micro with part number STM32F410RBI6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). SP3203ECY-L/TR from EXAR Corp
3). 182-009-113R531 from Norcomp Inc
4). ABLS-25.000MHZ-B2F-T from ABRACON
5). ASEK-32.768KHz-ECST from abracon
