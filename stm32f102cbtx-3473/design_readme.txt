...
Circuit Description: Design uses a controller from ST Micro with part number STM32F102CBT6 and following parts in the design:
1). BMC150 from Bosch Sensortec
2). FT232RL-REEL from FTDI Ltd
3). 10118193-0001LF from FCI
4). MAG3110FCR1 from Freescale Semiconductor
