...
Circuit Description: Design uses a controller from ST Micro with part number STM32F378RCY6 and following parts in the design:
1). A2200-A from Maestro Wireless Solutions
2). 73412-0114 from Molex
3). FTSH-105-01-L-DV-K from Samtec
4). 24AA04-I/MC from Microchip
5). ASEK-2-32.768KHz-ECST from abracon
...
11). LSF0102DCTR from Texas Instrument
