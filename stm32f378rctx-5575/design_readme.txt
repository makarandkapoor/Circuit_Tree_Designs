...
Circuit Description: Design uses a controller from ST Micro with part number STM32F378RCT6 and following parts in the design:
1). l3g4200d from ST
2). LTC2804CGN-1#PBF from Linear Tech
3). 182-009-113R531 from Norcomp Inc
4). ASEK-2-32.768KHz-ECST from abracon
5). ASDMB-25.000MHZ-EC-T from abracon
6). ltc3406es5 from Linear Tech
7). LP2951ACSDX/NOPB from TI
