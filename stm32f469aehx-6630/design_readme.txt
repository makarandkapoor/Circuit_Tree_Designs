...
Circuit Description: Design uses a controller from ST Micro with part number STM32F469AEH6 and following parts in the design:
1). CY62147GE30-45BVXI from Cypress
2). MAX3051EKA+T from Maxim Integrated
3). 182-009-113R531 from Norcomp Inc
4). MCP2562-E/SN from Microchip
5). 182-009-113R531 from Norcomp Inc
6). 0472192001 from Molex
