...
Circuit Description: Design uses a controller from ST Micro with part number STM32F302RBT7 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). LTC2804CGN-1#PBF from Linear Tech
...
9). 61400416021 from Wurth Electronics
