...
Circuit Description: Design uses a controller from ST Micro with part number STM32F101RFT6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). ASEK-32.768KHz-ECST from abracon
3). ASFL1-25MHZ-NCS from abracon
