...
Circuit Description: Design uses a controller from ST Micro with part number STM32L083CBT6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). SPBTLE-RF from ST Microelectronics
