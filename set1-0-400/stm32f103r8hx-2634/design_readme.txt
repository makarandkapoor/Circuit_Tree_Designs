...
Circuit Description: Design uses a controller from ST Micro with part number stm32f103r8h7 and following parts in the design:
1). ESP8266-12E from Ai Thinker
2). ETRX3587 from Telegesis
3). FTSH-105-01-L-DV-K from Samtec
4). LIS2HH12TR from STMicroelectronics
