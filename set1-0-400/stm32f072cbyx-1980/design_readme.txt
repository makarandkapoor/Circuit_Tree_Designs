...
Circuit Description: Design uses a controller from ST Micro with part number stm32f072cby6 and following parts in the design:
1). ABLS-25.000MHZ-B2F-T from ABRACON
2). ASEK-32.768KHz-ECST from abracon
3). LP3878SDX-ADJ/NOPB  from TI
