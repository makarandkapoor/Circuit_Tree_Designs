...
Circuit Description: Design uses a controller from ST Micro with part number STM32L082KZT6 and following parts in the design:
1). AT25020B-SSHL-T from Atmel
2). SP3203ECY-L/TR from EXAR Corp
3). 182-009-113R531 from Norcomp Inc
4). SP3203ECY-L/TR from EXAR Corp
