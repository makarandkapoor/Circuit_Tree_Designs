...
Circuit Description: Design uses a controller from ST Micro with part number STM32L051R8T7 and following parts in the design:
1). AT25020B-SSHL-T from Atmel
2). TMP75BID from Silicon Labs
