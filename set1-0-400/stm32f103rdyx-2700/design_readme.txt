...
Circuit Description: Design uses a controller from ST Micro with part number stm32f103rdy6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). 24AA16-I/MC from Microchip
3). mtfc4gmcdm from Micron
4). Si7051-A20-IM from Silicon Labs
