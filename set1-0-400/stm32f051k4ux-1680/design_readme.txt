...
Circuit Description: Design uses a controller from ST Micro with part number stm32f051k4u7 and following parts in the design:
1). BMG250 from Bosch Sensortec
2). ASFL1-25MHZ-NCS from abracon
