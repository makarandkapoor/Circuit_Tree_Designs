...
Circuit Description: Design uses a controller from ST Micro with part number STM32L041K6T7 and following parts in the design:
1). TST-110-05-T-D-RA from Samtec
2). MBH7BLZ02-109004 from Fujitsu
3). SP3203ECY-L/TR from EXAR Corp
4). HTSS-105-01-G-D from samtec
5). ABS07-32.768KHZ-7-T from ABRACON
6). ASFL1-12MHZ-NCS from abracon
