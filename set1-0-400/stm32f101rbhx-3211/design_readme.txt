...
Circuit Description: Design uses a controller from ST Micro with part number STM32F101RBH6 and following parts in the design:
1). AT25010B-SSHL-T from Atmel
2). AT25M01-SSHM-T from Atmel
3). FT232RL-REEL from FTDI Ltd
4). 10118193-0001LF from FCI
5). MAX3218EAP+T from Maxim Integrated
