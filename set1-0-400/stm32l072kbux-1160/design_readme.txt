...
Circuit Description: Design uses a controller from ST Micro with part number STM32L072KBU6 and following parts in the design:
1). ASEK-32.768KHz-ECST from abracon
2). LP2951ACSDX/NOPB from TI
3). TPS3895ADRYR from Texas Instruments
4). PJ-037B from CUI Inc.
5). 4-1437565-2 from TE connectivity
6). Q65110A2395 from osram
7). nc7sz125m5x from On Semi
