...
Circuit Description: Design uses a controller from ST Micro with part number stm32f058t8y6 and following parts in the design:
1). M24M02-DRMN6TP from ST
2). ABLS-25.000MHZ-B2F-T from ABRACON
3). ASEK-2-32.768KHz-ECST from abracon
4). IR3899MTR1PBF from Infineon
