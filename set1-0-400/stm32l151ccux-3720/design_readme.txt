...
Circuit Description: Design uses a controller from ST Micro with part number STM32L151CCU6 and following parts in the design:
1). AT25020B-SSHL-T from Atmel
2). MAX3218EAP+T from Maxim Integrated
3). HTSS-105-01-G-D from samtec
4). 24AA32AT-I/MNY from Microchip
