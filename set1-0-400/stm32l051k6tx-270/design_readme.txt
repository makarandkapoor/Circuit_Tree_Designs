...
Circuit Description: Design uses a controller from ST Micro with part number STM32L051K6T6 and following parts in the design:
1). 24AA00T-I/MNY from Microchip
2). SPBTLE-RF from ST Microelectronics
3). ABS07-32.768KHZ-7-T from ABRACON
4). MIC5234YME from microchip
