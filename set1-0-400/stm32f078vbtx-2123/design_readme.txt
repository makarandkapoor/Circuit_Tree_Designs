...
Circuit Description: Design uses a controller from ST Micro with part number stm32f078vbt6 and following parts in the design:
1). 24AA1025T-I/SN from Microchip
2). RFM75-S from HopeRF
3). 10118193-0001LF from FCI
4). prtr5v0u2ax from NXP
5). ABS07-32.768KHZ-7-T from ABRACON
6). ASDMB-25.000MHZ-EC-T from abracon
7). ltc3406es5 from Linear Tech
8). LP2951ACSDX/NOPB from TI
...
12). LSF0204DRUTR from Texas Instrument
