...
Circuit Description: Design uses a controller from ST Micro with part number STM32F101TBU6 and following parts in the design:
1). AT25128B-SSHL-T from Atmel
2). MAX3218EAP+T from Maxim Integrated
3). 182-009-113R531 from Norcomp Inc
4). MPL3115A2R1 from Freescale Semiconductor
