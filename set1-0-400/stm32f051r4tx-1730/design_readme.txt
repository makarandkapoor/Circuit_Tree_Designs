...
Circuit Description: Design uses a controller from ST Micro with part number stm32f051r4t6 and following parts in the design:
1). AT25040B-SSHL-T from Atmel
2). TST-110-05-T-D-RA from Samtec
3). ASEK-32.768KHz-ECST from abracon
4). ASFL1-25MHZ-NCS from abracon
