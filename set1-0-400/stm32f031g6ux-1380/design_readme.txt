...
Circuit Description: Design uses a controller from ST Micro with part number stm32f031g6u7 and following parts in the design:
...
5). ltc3406es5 from Linear Tech
6). TPS3895ADRYR from Texas Instruments
7). MCP73831T-2ACI/MC from microchip
8). S2B-PH-SM4-TB(LF)(SN) from JST Sales America Inc.
9). 10118193-0001LF from FCI
10). 4-1437565-2 from TE connectivity
11). Q65110A2395 from osram
12). nc7sz125m5x from On Semi
