...
Circuit Description: Design uses a controller from ST Micro with part number STM32F303RBT6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). AT24C02D-SSHM-T from Atmel
3). AT24C02D-SSHM-T from Atmel
4). ST3241EBPR from ST Microelectronics
