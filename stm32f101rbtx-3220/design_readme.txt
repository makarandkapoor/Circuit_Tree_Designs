...
Circuit Description: Design uses a controller from ST Micro with part number STM32F101RBT6 and following parts in the design:
1). AT25020B-SSHL-T from Atmel
2). AT25040B-SSHL-T from Atmel
3). FT232RL-REEL from FTDI Ltd
4). 10118193-0001LF from FCI
5). FTSH-105-01-L-DV-K from Samtec
