...
Circuit Description: Design uses a controller from ST Micro with part number STM32F301C8Y6 and following parts in the design:
1). TST-110-05-T-D-RA from Samtec
2). LTC2804CGN-1#PBF from Linear Tech
3). HTSS-105-01-G-D from samtec
4). 24AA256-I/MF from Microchip
