...
Circuit Description: Design uses a controller from ST Micro with part number STM32F302CBT6 and following parts in the design:
1). AT25040B-SSHL-T from Atmel
2). FTSH-105-01-L-DV-K from Samtec
3). 24AA1025T-I/SN from Microchip
