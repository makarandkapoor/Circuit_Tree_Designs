...
Circuit Description: Design uses a controller from ST Micro with part number stm32f038e6y7 and following parts in the design:
1). S25FL128SDPNFI001 from Spansion
2). SI7006-A20-IM from Silicon Labs
3). ABLS-25.000MHZ-B2F-T from ABRACON
4). LP3878SDX-ADJ/NOPB  from TI
5). LP2951ACSDX/NOPB from TI
6). TPS3895ADRYR from Texas Instruments
7). PJ-037B from CUI Inc.
8). LSF0102DCTR from Texas Instrument
