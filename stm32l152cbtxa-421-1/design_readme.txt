...
Circuit Description: Design uses a controller from ST Micro with part number STM32L152CBT6A and following parts in the design:
1). AT25080B-SSHL-T from Atmel
2). TST-110-05-T-D-RA from Samtec
3). LTC2804CGN-1#PBF from Linear Tech
4). HTSS-105-01-G-D from samtec
5). S25FL128SDPNFI001 from Spansion
6). 10118193-0001LF from FCI
7). prtr5v0u2ax from NXP
8). ASEK-32.768KHz-ECST from abracon
9). ASFL1-25MHZ-NCS from abracon
10). ltc3406es5 from Linear Tech
11). TPS3895ADRYR from Texas Instruments
12). MCP73831T-2ACI/MC from microchip
13). S2B-PH-SM4-TB(LF)(SN) from JST Sales America Inc.
