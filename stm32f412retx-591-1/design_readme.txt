...
Circuit Description: Design uses a controller from ST Micro with part number STM32F412RET6 and following parts in the design:
1). AT25M01-SSHM-T from Atmel
2). TST-110-05-T-D-RA from Samtec
3). AT24C02D-SSHM-T from Atmel
4). SI7006-A20-IM from Silicon Labs
