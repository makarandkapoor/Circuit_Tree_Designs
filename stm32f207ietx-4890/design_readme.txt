...
Circuit Description: Design uses a controller from ST Micro with part number STM32F207IET6 and following parts in the design:
1). arducam_ov2640 from arducam
2). AT24C02D-SSHM-T from Atmel
3). 24AA16-I/MC from Microchip
4). PC28F512P33BFD from Micron
5). ABS07-32.768KHZ-7-T from ABRACON
6). ASFL1-25MHZ-NCS from abracon
7). idt74fct38072 from IDT
