...
Circuit Description: Design uses a controller from ST Micro with part number STM32F756BGT6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). mt28ew256aba1HPC-0SIT from Micron
3). TUSB1210BRHBR from Texas Instruments
4). 47590-0001 from Molex
5). prtr5v0u2ax from NXP
6). MAX4995AAUT+T from Maxim
7). ABLS-25.000MHZ-B2F-T from ABRACON
8). ASEK-32.768KHz-ECST from abracon
9). ASFL1-19.2MHZ-NCS from abracon
