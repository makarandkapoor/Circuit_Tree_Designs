...
Circuit Description: Design uses a controller from ST Micro with part number STM32L433CBY6 and following parts in the design:
1). FT232RL-REEL from FTDI Ltd
2). 10118193-0001LF from FCI
3). FTSH-105-01-L-DV-K from Samtec
4). SST26WF016B-104I/MF from Microchip
...
9). ABLS-12.000MHZ-B4-T from ABRACON
