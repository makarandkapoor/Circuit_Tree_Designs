...
Circuit Description: Design uses a controller from ST Micro with part number stm32f098vct6 and following parts in the design:
1). TST-110-05-T-D-RA from Samtec
2). ABLS-25.000MHZ-B2F-T from ABRACON
3). ASEK-2-32.768KHz-ECST from abracon
4). ltc3406es5 from Linear Tech
5). TPS3895ADRYR from Texas Instruments
6). MCP73831T-2ACI/MC from microchip
7). S2B-PH-SM4-TB(LF)(SN) from JST Sales America Inc.
8). 10118193-0001LF from FCI
9). 4-1437565-2 from TE connectivity
10). Q65110A2395 from osram
11). nc7sz125m5x from On Semi
