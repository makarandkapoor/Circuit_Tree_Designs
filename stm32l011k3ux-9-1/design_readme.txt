...
Circuit Description: Design uses a controller from ST Micro with part number STM32L011K3U6 and following parts in the design:
1). AT25256B-SSHL-T from Atmel
2). TST-110-05-T-D-RA from Samtec
3). ABS07-32.768KHZ-7-T from ABRACON
4). ASFL1-12MHZ-NCS from abracon
