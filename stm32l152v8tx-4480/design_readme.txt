...
Circuit Description: Design uses a controller from ST Micro with part number STM32L152V8T6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). MPU-9250 from TDK InvenSense
