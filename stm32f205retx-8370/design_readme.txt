...
Circuit Description: Design uses a controller from ST Micro with part number STM32F205RET7 and following parts in the design:
1). 24AA02T-I/MNY from Microchip
2). TMD27711 from AMS
3). TUSB1210BRHBR from Texas Instruments
4). 47590-0001 from Molex
5). prtr5v0u2ax from NXP
6). MAX4995AAUT+T from Maxim
7). XB24CZ7UIS-004 from Digi International
