...
Circuit Description: Design uses a controller from ST Micro with part number STM32F407ZGT6 and following parts in the design:
1). 10100565 from Amphenol
2). ST3241EBPR from ST Microelectronics
3). HTSS-105-01-G-D from samtec
4). USB3317C-CP-TR from Microchip Technology
5). 47590-0001 from Molex
6). prtr5v0u2ax from NXP
7). MAX4995AAUT+T from Maxim
