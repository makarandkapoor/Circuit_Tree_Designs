...
Circuit Description: Design uses a controller from ST Micro with part number STM32F101RET6 and following parts in the design:
1). TST-110-05-T-D-RA from Samtec
2). LTC2804CGN-1#PBF from Linear Tech
3). 182-009-113R531 from Norcomp Inc
4). M41T65Q6F from ST Microelectronics
5). ABS07-32.768KHZ-7-T from ABRACON
6). ABS07-32.768KHZ-7-T from ABRACON
7). ASFL1-25MHZ-NCS from abracon
8). ltc3406es5 from Linear Tech
9). TPS3895ADRYR from Texas Instruments
10). MCP73831T-2ACI/MC from microchip
11). S2B-PH-SM4-TB(LF)(SN) from JST Sales America Inc.
12). 10118193-0001LF from FCI
13). 4-1437565-2 from TE connectivity
14). Q65110A2395 from osram
15). nc7sz125m5x from On Semi
