...
Circuit Description: Design uses a controller from ST Micro with part number STM32L431RBY6 and following parts in the design:
1). AT25M01-SSHM-T from Atmel
2). TST-110-05-T-D-RA from Samtec
3). MCP2562-E/SN from Microchip
4). 182-009-113R531 from Norcomp Inc
5). ABLS-25.000MHZ-B2F-T from ABRACON
6). ASEK-32.768KHz-ECST from abracon
7). MIC5234YME from microchip
8). LT3494AEDDB#TRMPBF from Linear Tech
