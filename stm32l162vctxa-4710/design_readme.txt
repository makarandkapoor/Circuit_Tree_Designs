...
Circuit Description: Design uses a controller from ST Micro with part number STM32L162VCT6A and following parts in the design:
1). SP3203ECY-L/TR from EXAR Corp
2). HTSS-105-01-G-D from samtec
3). 10118193-0001LF from FCI
4). prtr5v0u2ax from NXP
5). XB24CZ7UIS-004 from Digi International
