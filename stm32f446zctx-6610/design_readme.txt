...
Circuit Description: Design uses a controller from ST Micro with part number STM32F446ZCT6 and following parts in the design:
1). HDC1080DMBR from Texas Instruments
2). TST-110-05-T-D-RA from Samtec
3). 24AA01T-I/MNY from Microchip
4). 24AA64T-I/MNY from Microchip
