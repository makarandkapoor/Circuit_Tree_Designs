...
Circuit Description: Design uses a controller from ST Micro with part number stm32f401CBU6 and following parts in the design:
1). AT25040B-SSHL-T from Atmel
2). 24AA04-I/MC from Microchip
3). 24AA08T-I/MNY from Microchip
4). TSC2046IRGVR from Texas Instruments
