...
Circuit Description: Design uses a controller from ST Micro with part number STM32F767ZGT6 and following parts in the design:
1). AT25010B-SSHL-T from Atmel
2). AT25M02-SSHD-T from Atmel
3). FTSH-105-01-L-DV-K from Samtec
4). mtfc4gmcdm from Micron
5). RFM75-S from HopeRF
6). S25FL128SDPNFI001 from Spansion
