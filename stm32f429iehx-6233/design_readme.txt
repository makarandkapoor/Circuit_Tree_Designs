...
Circuit Description: Design uses a controller from ST Micro with part number STM32F429IEH6 and following parts in the design:
1). FTSH-105-01-L-DV-K from Samtec
2). RFM75-S from HopeRF
3). S29VS256RABBHW000 from Spansion
4). 88-00153-02 from murata
5). ABLS-25.000MHZ-B2F-T from ABRACON
6). ASEK-32.768KHz-ECST from abracon
7). LP3878SDX-ADJ/NOPB  from TI
8). LP3878SDX-ADJ/NOPB  from TI
9). TPS3895ADRYR from Texas Instruments
10). PJ-037B from CUI Inc.
11). LSF0204DRUTR from Texas Instrument
