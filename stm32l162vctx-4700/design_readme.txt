...
Circuit Description: Design uses a controller from ST Micro with part number STM32L162VCTx and following parts in the design:
1). AT25020B-SSHL-T from Atmel
2). TST-110-05-T-D-RA from Samtec
3). SPBTLE-RF from ST Microelectronics
...
10). ASEK-32.768KHz-ECST from abracon
