...
Circuit Description: Design uses a controller from ST Micro with part number STM32F215VET6 and following parts in the design:
1). 10100565 from Amphenol
2). TST-110-05-T-D-RA from Samtec
3). 24AA04-I/MC from Microchip
4). mt29f4g08abadah4 from Micron
