...
Circuit Description: Design uses a controller from ST Micro with part number STM32L011E4Y6 and following parts in the design:
1). SP3203ECY-L/TR from EXAR Corp
2). 182-009-113R531 from Norcomp Inc
3). XB24CZ7UIS-004 from Digi International
4). ABS07-32.768KHZ-7-T from ABRACON
5). ASFL1-12MHZ-NCS from abracon
6). MIC5234YME from microchip
7). TPS3895ADRYR from Texas Instruments
8). MCP73831T-2ACI/MC from microchip
9). S2B-PH-SM4-TB(LF)(SN) from JST Sales America Inc.
