...
Circuit Description: Design uses a controller from ST Micro with part number STM32F777ZIT6 and following parts in the design:
1). AT25020B-SSHL-T from Atmel
2). FTSH-105-01-L-DV-K from Samtec
3). MAG3110FCR1 from Freescale Semiconductor
...
9). SP3203ECY-L/TR from EXAR Corp
