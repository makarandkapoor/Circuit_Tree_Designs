...
Circuit Description: Design uses a controller from ST Micro with part number STM32F745VGH6 and following parts in the design:
1). 10100565 from Amphenol
2). Si7034-A10-IM from Silicon Labs
3). SST26WF016B-104I/MF from Microchip
4). ASEK-32.768KHz-ECST from abracon
5). ASFL1-25MHZ-NCS from abracon
6). IR3899MTR1PBF from Infineon
7). tps54225PWP from Texas Instruments
8). LP2951ACSDX/NOPB from TI
9). IR3899MTR1PBF from Infineon
10). LTC2928CUHF#PBF from Linear Tech
11). IRF8306MTRPbF from Infineon
12). IRF8306MTRPbF from Infineon
