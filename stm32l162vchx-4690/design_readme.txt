...
Circuit Description: Design uses a controller from ST Micro with part number STM32L162VCH6 and following parts in the design:
1). AT25M02-SSHD-T from Atmel
2). FT232RL-REEL from FTDI Ltd
3). 10118193-0001LF from FCI
4). FT232RL-REEL from FTDI Ltd
5). 10118193-0001LF from FCI
6). FTSH-105-01-L-DV-K from Samtec
7). SPBTLE-RF from ST Microelectronics
8). ABLS-12.000MHZ-B4-T from ABRACON
9). ASEK-32.768KHz-ECST from abracon
10). ASFL1-12MHZ-NCS from abracon
