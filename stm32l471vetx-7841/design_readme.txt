...
Circuit Description: Design uses a controller from ST Micro with part number STM32L471VET6 and following parts in the design:
1). 24AA00T-I/MNY from Microchip
2). mtfc4gmcdm from Micron
3). SN65HVD230D from Texas Instruments
4). 182-009-113R531 from Norcomp Inc
5). SST26VF032B-104I/MF from Microchip
6). ST3241EBPR from ST Microelectronics
7). HTSS-105-01-G-D from samtec
