...
Circuit Description: Design uses a controller from ST Micro with part number stm32f042f4p7 and following parts in the design:
1). TST-110-05-T-D-RA from Samtec
2). ASFL1-25MHZ-NCS from abracon
3). LP2954AIMX/NOPB from TI
4). TPS3895ADRYR from Texas Instruments
5). PJ-037B from CUI Inc.
6). 4-1437565-2 from TE connectivity
7). Q65110A2395 from osram
8). nc7sz125m5x from On Semi
