...
Circuit Description: Design uses a controller from ST Micro with part number STM32F407VET6 and following parts in the design:
1). BCM5221KPT from Broadcom Corporation
2). 7498011122R from WURTH ELEKTRONIK
3). AT24C02D-SSHM-T from Atmel
4). mt29f4g08abbdah4 from Micron
